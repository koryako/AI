...
public class UserListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        add_Iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				  Intent newIntent = new Intent(UserListActivity.this, AddUserActivity.class);
		...
		filter.addAction("1_2");
		filter.addAction("1_4");
		...
		registerReceiver(userBroadcastReceiver, filter);
		  ...
		  try {
				WriteUtil.write(MsgId_E.MSGID_USER.getVal(),0,MsgType_E.MSGTYPE_REQ.getVal(),MsgOper_E.MSGOPER_QRY.getVal(),(short)2, new MsgQryReq_S((short) 0).getMsgQryReq_S());
			} catch (IOException e) {
				// TODO Auto-generated catch block
				Toast.makeText(UserListActivity.this, "获取列表失败", Toast.LENGTH_LONG).show();
			}

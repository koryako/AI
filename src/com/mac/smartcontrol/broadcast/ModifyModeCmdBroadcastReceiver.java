...
public class ModifyModeCmdBroadcastReceiver extends BroadcastReceiver {

	Activity activity;

	public ModifyModeCmdBroadcastReceiver(Activity activity) {
		super();
	...
	public void onReceive(Context context, Intent intent) {
		...
		ModifyModeCmdActivity addModeCmdActivity = (ModifyModeCmdActivity) activity;
		...
		if (msgId == MsgId_E.MSGID_MODECMD.getVal()
			...
			if (msgModAck_S.getUsError() == 0) {
				...
				addModeCmdActivity.modeCmd_S.setUsIdx(msgModAck_S.getUsIdx());

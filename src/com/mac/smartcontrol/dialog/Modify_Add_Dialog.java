...
public class Modify_Add_Dialog extends Dialog {
	...
	public Modify_Add_Dialog(Context context, String titleName, short msgId,
			byte msgOper, short size, byte[] body) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit_Iv.setOnClickListener(new android.view.View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// try {
				WriteUtil.write(msgId, 0, MsgType_E.MSGTYPE_REQ.getVal(),
						msgOper, size, body, context);
				Modify_Add_Dialog.this.dismiss();
				// } catch (IOException e) {
				// // TODO Auto-generated catch block
				// Toast.makeText(context, toast_msg, Toast.LENGTH_LONG)
				// .show();
				// }
			}
		});

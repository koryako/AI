...
public class CmdListAdapter extends BaseAdapter {
	...
	public CmdListAdapter(Context context, List<Cmd_S> cmdList,Map<Short,Ctrl_S> ctrlMap,Appl_S appl_S) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			ImageView cmd_icon_Iv=(ImageView) convertView.findViewById(R.id.cmd_icon);
			TextView cmd_name_Tv=(TextView) convertView.findViewById(R.id.cmd_name_tv);
			MarqueeText voice_name_Tv=(MarqueeText) convertView.findViewById(R.id.voice_name_tv);
			MarqueeText ctrl_name_Tv=(MarqueeText) convertView.findViewById(R.id.ctrl_name_tv);
			...
			if(cmd_S.getUcDevType()==1){
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					try {
						WriteUtil.write(MsgId_E.MSGID_CMD.getVal(),0,MsgType_E.MSGTYPE_REQ.getVal(),MsgOper_E.MSGOPER_DEL.getVal(),MsgDelReq_S.getSize(), new MsgDelReq_S(cmd_S.getUsIdx()).getMsgDelReq_S());

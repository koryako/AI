...
public class ControllerListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView=localinflater.inflate(R.layout.controller_list_item, null);
			TextView controller_name_Tv=(TextView) convertView.findViewById(R.id.controller_name);
			TextView controller_address_Tv=(TextView) convertView.findViewById(R.id.controller_address);
			TextView controller_state_Tv=(TextView) convertView.findViewById(R.id.controller_state);
			...
			controller_name_Tv.setText(ctrl_S.getSzName());
			controller_address_Tv.setText(ctrl_S.getUlAddr()+"");
			if(ctrl_S.getUcStatus()==1){
				controller_state_Tv.setText("在线");
				delete_Iv.setVisibility(View.GONE);
			}else if(ctrl_S.getUcStatus()==2){
				controller_state_Tv.setText("离线");
			}
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					try {
						WriteUtil.write(MsgId_E.MSGID_CTRL.getVal(),0,MsgType_E.MSGTYPE_REQ.getVal(),MsgOper_E.MSGOPER_DEL.getVal(),MsgDelReq_S.getSize(), new MsgDelReq_S(ctrl_S.getUsIdx()).getMsgDelReq_S());
		    			...
		    			public void onClick(View v) {
		    				...
		    				if(ctrl_S.getSzName().equals(name)){
		    				  ...
		    				  try {
		    					  ...
		    					  WriteUtil.write(MsgId_E.MSGID_CTRL.getVal(),0,MsgType_E.MSGTYPE_REQ.getVal(),MsgOper_E.MSGOPER_MOD.getVal(),Ctrl_S.getSize(), ctrl_S.getCtrl_S());

...
public class UserListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			TextView userType_Tv=(TextView) convertView.findViewById(R.id.userType);
			...
			if(user_S.getSzName().equals("admin")){
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					try {
						WriteUtil.write(MsgId_E.MSGID_USER.getVal(),0,MsgType_E.MSGTYPE_REQ.getVal(),MsgOper_E.MSGOPER_DEL.getVal(),MsgDelReq_S.getSize(), new MsgDelReq_S(user_S.getUsIdx()).getMsgDelReq_S());

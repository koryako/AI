...
public class MsgApplQryByRgnAck_S {
	  short usRgnIdx;       // 区域索引
	  byte ucErr;  
	  short usCnt;          // 对象数量
	  byte[]pucData;     // 对象结构，多个
	  public MsgApplQryByRgnAck_S() {
		super();
		// TODO Auto-generated constructor stub
	}
	  public MsgApplQryByRgnAck_S(short usRgnIdx, byte ucErr, short usCnt,
			byte[] pucData) {
		super();
	...
	public void setMsgApplQryByRgnAck_S(byte[] b){
